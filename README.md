...
> 
> InputSwitch is the smarter, unified solution for seamless input switching, key remapping, and more—built for people who work in multiple languages or want a better typing experience on Mac.

![App Icon](./assets/icon.png)

---

## Why People Need InputSwitch
...
## What Makes InputSwitch Different?
...
## How InputSwitch Solves Your Problems
...
Let InputSwitch analyze your context and switch input methods for you. Perfect for multilingual users and fast-paced workflows.
...
### 🚀 Launch at Login
Never forget to start your productivity tools. InputSwitch can launch automatically every time you log in.

### 🌏 Internationalization (i18n) Support
Use InputSwitch in your native language, or help translate for others.

---

## Get Started in Minutes

1. **Download** the latest release from [Releases](https://github.com/yourusername/InputSwitch/releases)
2. **Drag** `InputSwitch.app` to your Applications folder
3. **Open** the app and grant necessary permissions
4. **Set up** your hotkeys and preferences in Settings

---

## Who Is InputSwitch For?
